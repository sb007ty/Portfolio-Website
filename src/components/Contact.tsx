        ...
        <div className="contact-info" style={{ maxWidth: '600px', width: '100%' }}>
          <div className="contact-card glass-card">
            ...
            <div className="social-links">
              ...
              <a href="https://www.linkedin.com/in/spandan-banerjee-1119b5172/" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="LinkedIn" id="contact-linkedin-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
